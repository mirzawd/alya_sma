...
module def_jacobi
  ...
  type, extends(stationary)       :: jacobi
   contains
     procedure,               pass :: init     
...
contains
  ...
  !> @date    2022-03-02
  !> @brief   Jacobi solver
  !> @details Jacobi solver
  !> 
  !-----------------------------------------------------------------------

  subroutine init(self)
    
    class(jacobi), intent(inout) :: self
  ...
  subroutine setup(self,a)
    ...
    class(jacobi),                      intent(inout) :: self          !< Solver
...
1   continue
  ...
  subroutine mv(self,x,y,a)
    ...
    class(jacobi),            intent(in)    :: self          !< Solver
