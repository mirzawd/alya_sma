...
!-----------------------------------------------------------------!
  ...
  subroutine ker_vorte1(vered,coord_vort)
    !  
    !  cell based
    !
    ...
    real(rp),   intent(out) :: coord_vort(ndime,*)
  ...
  end subroutine ker_vorte1

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

  subroutine ker_vorte2(vered,coord_vort)
    !  
    !  Face based
    !
