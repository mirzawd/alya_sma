...
!- iuse pnode (that is a parameter) instead of mnode
...
module mod_nsi_element_operations_hh76
...
!hhh  
!hhh  private
!hhh  public :: nsi_element_operations_hh76
!hhh
!hhhcontains
!hhh
!hhh  !-----------------------------------------------------------------------
...
!hhh  subroutine nsi_element_operations_hh76(&
...
!hhh    real(rp)                         :: gpcar(VECTOR_DIM,ndime,pnode,pgaus)              ! dN/dxi
...
!hhh             gpcar(ivect,1:ndime,1:pnode,1:pgaus) = elmda_gpcar(1:ndime,1:pnode,1:pgaus,ielem)
!hhh          else
!hhh             gpvol(ivect,1:pgaus)                 = 0.0_rp
!hhh             gpcar(ivect,1:ndime,1:pnode,1:pgaus) = 0.0_rp
!hhh          end if
!hhh#ifndef OPENACCHHH
!hhh       end do
!hhh#endif
...
!hhh!      call nsi_corio_element_operationshh76(pnode,pgaus,gpvol,gpden,gpsha,elauu)
!hhh    end if    
!hhh#endif
!hhh
!hhh    !--------------------------------------------------------------------
...
!hhh!           list_elements,lnods_loc,visco_nsi)
!hhh    end if
!hhh
!hhh
...
!hhh#endif
!hhh
!hhh  end subroutine nsi_element_operations_hh76

end module mod_nsi_element_operations_hh76
