...
module mod_nsi_element_operations_hh71
...
#include "def_vector_size.inc"
  ...
  private
  public :: nsi_element_operations_hh71
...
contains
  ...
  subroutine nsi_element_operations_hh71(&
...
!   gpvis=0.0
    ...
    if( kfl_stab_corio_nsi > 0_ip ) then  ! i could perhaps unify this better
       ...
       !
       call nsi_corio_element_operationshh71(pnode,pgaus,gpvol,gpden,gpsha,elauu)
    end if    
#endif
  ...
  end subroutine nsi_element_operations_hh71
  ...
  !>
  !-----------------------------------------------------------------------
!!!!!!Check if I actually need this subr
  subroutine nsi_corio_element_operationshh71(pnode,pgaus,gpvol,gpden,gpsha,elauu)
...
!@#endif
  ...
  end subroutine nsi_corio_element_operationshh71

end module mod_nsi_element_operations_hh71
!> @}
