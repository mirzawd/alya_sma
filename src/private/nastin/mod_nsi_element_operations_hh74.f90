...
module mod_nsi_element_operations_hh74
...
!hhh  
!hhh  private
!hhh  public :: nsi_element_operations_hh74
!hhh
!hhhcontains
!hhh
!hhh  !-----------------------------------------------------------------------
...
!hhh  subroutine nsi_element_operations_hh74(&
...
!hhh    !--------------------------------------------------------------------
!hhh
!hhh    gpmut(DEF_VECT,:) = gpden(DEF_VECT,:) * gpmut(DEF_VECT,:)           ! mut
!hhh    
!hhh    if(kfl_dampi_nsi /= 1_ip) then   ! normal behaviour
!hhh       gpvis(DEF_VECT,:) = gpvis(DEF_VECT,:) + gpmut(DEF_VECT,:)  ! Effective viscosity <= mu+mut
!hhh#ifndef OPENACCHHH
...
!hhh       !
!hhh       call runend('corio_stab not ready')
!hhh!      call nsi_corio_element_operationshh74(pnode,pgaus,gpvol,gpden,gpsha,elauu)
!hhh    end if    
!hhh#endif
!hhh
!hhh    !--------------------------------------------------------------------
...
!hhh#endif
!hhh
!hhh  end subroutine nsi_element_operations_hh74

end module mod_nsi_element_operations_hh74
