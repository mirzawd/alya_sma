...
!- 77   ishape y card especifica pnode=4  & y limpieza de unused
...
module mod_nsi_element_operations_hh77
...
!hhh  
!hhh  private
!hhh  public :: nsi_element_operations_hh77
!hhh
!hhhcontains
!hhh
!hhh  !-----------------------------------------------------------------------
...
!hhh  subroutine nsi_element_operations_hh77(&
...
!hhh    ! 3D P1 element
!hhh    !
!hhh    gpcar(DEF_VECT,1,1,1) =  elcod(DEF_VECT,1,2)   - elcod(DEF_VECT,1,1)
!hhh    gpcar(DEF_VECT,1,2,1) =  elcod(DEF_VECT,1,3)   - elcod(DEF_VECT,1,1)
!hhh    gpcar(DEF_VECT,1,3,1) =  elcod(DEF_VECT,1,4)   - elcod(DEF_VECT,1,1)
!hhh    gpcar(DEF_VECT,2,1,1) =  elcod(DEF_VECT,2,2)   - elcod(DEF_VECT,2,1)
!hhh    gpcar(DEF_VECT,2,2,1) =  elcod(DEF_VECT,2,3)   - elcod(DEF_VECT,2,1)
!hhh    gpcar(DEF_VECT,2,3,1) =  elcod(DEF_VECT,2,4)   - elcod(DEF_VECT,2,1)
!hhh    gpcar(DEF_VECT,3,1,1) =  elcod(DEF_VECT,3,2)   - elcod(DEF_VECT,3,1)
!hhh    gpcar(DEF_VECT,3,2,1) =  elcod(DEF_VECT,3,3)   - elcod(DEF_VECT,3,1)
!hhh    gpcar(DEF_VECT,3,3,1) =  elcod(DEF_VECT,3,4)   - elcod(DEF_VECT,3,1)
!hhh    T1X          =  gpcar(DEF_VECT,2,2,1) * gpcar(DEF_VECT,3,3,1) - gpcar(DEF_VECT,3,2,1) * gpcar(DEF_VECT,2,3,1)
!hhh    T2X          = -gpcar(DEF_VECT,2,1,1) * gpcar(DEF_VECT,3,3,1) + gpcar(DEF_VECT,3,1,1) * gpcar(DEF_VECT,2,3,1)
!hhh    T3X          =  gpcar(DEF_VECT,2,1,1) * gpcar(DEF_VECT,3,2,1) - gpcar(DEF_VECT,3,1,1) * gpcar(DEF_VECT,2,2,1)
!hhh    gpdet(DEF_VECT)     =  gpcar(DEF_VECT,1,1,1) * T1X + gpcar(DEF_VECT,1,2,1) * T2X + gpcar(DEF_VECT,1,3,1) * T3X
!hhh
!hhh
...
!hhh    xjaci(DEF_VECT,2,2) = ( gpcar(DEF_VECT,1,1,1) * gpcar(DEF_VECT,3,3,1) - gpcar(DEF_VECT,3,1,1) * gpcar(DEF_VECT,1,3,1)) * DENOMX
!hhh    xjaci(DEF_VECT,3,2) = (-gpcar(DEF_VECT,1,1,1) * gpcar(DEF_VECT,3,2,1) + gpcar(DEF_VECT,1,2,1) * gpcar(DEF_VECT,3,1,1)) * DENOMX
!hhh    xjaci(DEF_VECT,3,3) = ( gpcar(DEF_VECT,1,1,1) * gpcar(DEF_VECT,2,2,1) - gpcar(DEF_VECT,2,1,1) * gpcar(DEF_VECT,1,2,1)) * DENOMX
!hhh    xjaci(DEF_VECT,1,2) = (-gpcar(DEF_VECT,1,2,1) * gpcar(DEF_VECT,3,3,1) + gpcar(DEF_VECT,3,2,1) * gpcar(DEF_VECT,1,3,1)) * DENOMX
!hhh    xjaci(DEF_VECT,1,3) = ( gpcar(DEF_VECT,1,2,1) * gpcar(DEF_VECT,2,3,1) - gpcar(DEF_VECT,2,2,1) * gpcar(DEF_VECT,1,3,1)) * DENOMX
!hhh    xjaci(DEF_VECT,2,3) = (-gpcar(DEF_VECT,1,1,1) * gpcar(DEF_VECT,2,3,1) + gpcar(DEF_VECT,2,1,1) * gpcar(DEF_VECT,1,3,1)) * DENOMX
!hhh
!hhh    gpcar(DEF_VECT,1,1,1) = -xjaci(DEF_VECT,1,1) - xjaci(DEF_VECT,2,1) - xjaci(DEF_VECT,3,1)
!hhh    gpcar(DEF_VECT,1,2,1) =  xjaci(DEF_VECT,1,1)
!hhh    gpcar(DEF_VECT,1,3,1) =  xjaci(DEF_VECT,2,1)
!hhh    gpcar(DEF_VECT,1,4,1) =  xjaci(DEF_VECT,3,1)
!hhh    gpcar(DEF_VECT,2,1,1) = -xjaci(DEF_VECT,1,2) - xjaci(DEF_VECT,2,2) - xjaci(DEF_VECT,3,2)
!hhh    gpcar(DEF_VECT,2,2,1) =  xjaci(DEF_VECT,1,2)
!hhh    gpcar(DEF_VECT,2,3,1) =  xjaci(DEF_VECT,2,2)
!hhh    gpcar(DEF_VECT,2,4,1) =  xjaci(DEF_VECT,3,2)
!hhh    gpcar(DEF_VECT,3,1,1) = -xjaci(DEF_VECT,1,3) - xjaci(DEF_VECT,2,3) - xjaci(DEF_VECT,3,3)
!hhh    gpcar(DEF_VECT,3,2,1) =  xjaci(DEF_VECT,1,3)
!hhh    gpcar(DEF_VECT,3,3,1) =  xjaci(DEF_VECT,2,3)
!hhh    gpcar(DEF_VECT,3,4,1) =  xjaci(DEF_VECT,3,3)
!hhh
!hhh    do igaus = 2,pgaus
!hhh       do idime = 1,3
!hhh          do inode = 1,4
!hhh             gpcar(DEF_VECT,idime,inode,igaus) = gpcar(DEF_VECT,idime,inode,1)
!hhh          end do
!hhh       end do
!hhh    end do
!hhh
!hhh    do igaus = 1,pgaus
!hhh       gpvol(DEF_VECT,igaus) = weigp * gpdet(DEF_VECT)
!hhh!!!!!!!!!!!!!!!!!!!
...
!hhh!      call nsi_corio_element_operationshh77(pnode,pgaus,gpvol,gpden,gpsha,elauu)
!hhh    end if    
!hhh#endif
!hhh
!hhh    !--------------------------------------------------------------------
...
!hhh#endif
!hhh
!hhh  end subroutine nsi_element_operations_hh77

end module mod_nsi_element_operations_hh77
