...
module mod_nsi_element_operations_hh79
...
!hhh  
!hhh  private
!hhh  public :: nsi_element_operations_hh79
!hhh
!hhhcontains
!hhh
!hhh  !-----------------------------------------------------------------------
...
!hhh  subroutine nsi_element_operations_hh79(&
...
!hhh!   real(rp),parameter                             :: densi_aux = 1.229000D+00
!hhh!   real(rp),parameter                             :: visco_aux = 0.1730000D-05
!hhh
!hhh
!hhh    real(rp)                  :: visco_tot(VECTOR_DIM)
!hhh
!hhh    !
!hhh    ! Internal
!hhh    !
...
!hhh    end do
!hhh    do igaus = 1,pgaus
!hhh       FACT2X =  densi_aux * grnor_nsi
!hhh       do idime = 1,ndime
!hhh          do inode = 1,pnode
...
!hhh    endwhere
!hhh!    do igaus=1,pgaus
!hhh!       gpvis(:,igaus) = gpvis(:,igaus) + densi_aux * xnutu   ! creo  correcto  : gpvis(VECTOR_DIM,pgaus), xnutu(VECTOR_DIM,pgaus)
!hhh!    end do
!hhh    ! note taht now viscotot is not of size pgaus , just vectorsize
!hhh    visco_tot = visco_aux + densi_aux * xnutu
!hhh    
!hhh
!hhh!!!!!!!
!hhh
...
!hhh          FACT2X = densi_aux * FACT1X * ( gptem(DEF_VECT,igaus) - boutr_aux )
!hhh#else
!hhh          FACT2X = densi_aux * FACT1X * ( gptem(DEF_VECT,igaus) - boutr_nsi )
!hhh#endif
!hhh          do idime = 1,ndime
...
!hhh          !
!hhh          do idime = 1,ndime
!hhh             gprhs(DEF_VECT,idime,igaus) = gprhs(DEF_VECT,idime,igaus) - densi_aux &
...
!hhh                        - visco_tot(DEF_VECT) * gpvol(DEF_VECT) * gpcar(DEF_VECT,jdime,inode) * (gpgve(DEF_VECT,jdime,idime) + gpgve(DEF_VECT,idime,jdime))         ! viscous fvins_nsi==1 leads to bulkv=1.0
!hhh                  end do
!hhh               end do
!hhh            end do
!hhh         end do
...
!hhh                    densi_aux * ( gpvel(DEF_VECT,idime,igaus) - v_geo_damp_nsi(idime)) * val_r_damp_nsi  * &
...
!hhh!      call nsi_corio_element_operationshh79(pnode,pgaus,gpvol,gpden,gpsha,elauu)
!hhh    end if    
!hhh#endif
!hhh
!hhh    !--------------------------------------------------------------------
...
!hhh#endif
!hhh
!hhh  end subroutine nsi_element_operations_hh79

end module mod_nsi_element_operations_hh79
