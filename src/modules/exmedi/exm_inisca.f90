...
!> @brief   Initial condition setup for Paci 2013 Atrial-like model
!> @details provides unique initial conditions to the FEM
!> @} 
!!-----------------------------------------------------------------------
subroutine exm_inisca(ipoin)
!subroutine exm_inisca(kmodel_ipoin,ipoin)
  ...
  elmag(ipoin,:) = -70.0_rp     ! resting voltage
  ...
  vconc(3,ipoin,1:3) = 14.1_rp    !Na_i0
end subroutine exm_inisca
