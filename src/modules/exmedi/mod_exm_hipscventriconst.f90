...
!Cell size
real(rp), parameter :: &
C_m = 98.7109e-12_rp,    V_c = 8800.0_rp,    V_sr = 583.73_rp, &
!Maximum conductances and currents
g_Na = 3.6712302e3_rp,    g_to = 29.9038_rp,    g_K1 = 28.1492_rp,    P_NaK = 1.841424_rp,    K_NaCa = 4900.0_rp,    Vmax_up = 0.56064_rp
